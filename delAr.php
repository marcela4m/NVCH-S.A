...
<br><br><br>
					...
					<article class="grid_6">
						<div class="indent">
							<h2 class="indent-bot">ELIMINAR ARTICULO</h2>

							<ul class="list-2">
								
								
								
								<form action="delAr.php" method="post">
 ...
 <tr>
        <td>Id del articulo a eliminar:</td>
...
//echo "<h2> ingrese el id.</h2>";
			...
			if ($username_exist==0) {
				echo "<h2>El articulo no existe o ya se elimino</h2>";
				
			}else{
							
				$query = "DELETE FROM articulo WHERE id='$idd'";
				mysql_query($query) or die(mysql_error());
				echo 'El articulo ha sido eliminado de manera satisfactoria.<br />';
