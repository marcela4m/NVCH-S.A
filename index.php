					...
					<div class="container_12">
							...
							<nav>
								<ul class="menu">
									...
									<li class="active"><a href="index.php">INICIAR SESION</a><strong></strong></li>
...
<strong class="title-2">¡Tenemos un regalo para ti!</strong>
				...
				<div class="wrapper border-bot2 margin-bot">
					<article class="grid_6 spacer-2">
						<h2 class="indent-bot">INIGRESO AL SISTEMA</h2>
...
<br><br><br>
					...
					<article class="grid_6">
						<div class="indent">
							<h2 class="indent-bot">Bienvenido al nuevo sistema</h2>

							<ul class="list-2">
								
								<!-- <li class="last"><a href="#">Click Aqui</a></li> -->
								<figure class="img-indent"><img src="images/Regalos.jpg" alt="" /></figure>
							</ul>
						</div>
					</article>
				</div>
